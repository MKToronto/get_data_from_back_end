    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			h60 = element("h6");
    			h60.textContent = "Choose Charecter:";
    			t7 = space();
    			div4 = element("div");
    			...
    			add_location(input0, file$1, 81, 10, 2507);
    			add_location(h61, file$1, 88, 10, 2721);
    			add_location(label0, file$1, 80, 6, 2489);
    			attr_dev(div4, "class", "col-start-4 col-end-6 text-center");
    			add_location(div4, file$1, 79, 0, 2435);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 93, 10, 2842);
    			add_location(h62, file$1, 99, 10, 3034);
    			add_location(label1, file$1, 92, 6, 2824);
    			attr_dev(div5, "class", "col-start-6 col-end-8 text-center ");
    			add_location(div5, file$1, 91, 6, 2769);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 104, 6, 3150);
    			add_location(h63, file$1, 110, 6, 3322);
    			add_location(label2, file$1, 103, 6, 3136);
    			attr_dev(div6, "class", "col-start-8 col-end-10 text-center");
    			add_location(div6, file$1, 102, 4, 3081);
    			add_location(u, file$1, 116, 54, 3461);
    			add_location(h64, file$1, 116, 6, 3413);
    			add_location(small, file$1, 118, 6, 3504);
    			attr_dev(div7, "class", "col-start-4 col-end-10 ");
    			add_location(div7, file$1, 114, 4, 3368);
