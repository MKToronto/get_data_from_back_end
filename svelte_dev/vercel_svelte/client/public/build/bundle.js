    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 93, 12, 3182);
    			add_location(h61, file$1, 99, 12, 3385);
    			add_location(label0, file$1, 92, 10, 3162);
    			attr_dev(div6, "class", "text-center");
    			add_location(div6, file$1, 90, 8, 3059);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 104, 12, 3499);
    			add_location(h62, file$1, 110, 12, 3703);
    			add_location(label1, file$1, 103, 10, 3479);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 102, 8, 3443);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 115, 12, 3818);
    			add_location(h63, file$1, 121, 12, 4026);
    			add_location(label2, file$1, 114, 10, 3798);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 113, 8, 3762);
    			...
    			add_location(h64, file$1, 131, 6, 4248);
    			attr_dev(div13, "class", "col-start-2 col-end-12 text-center");
    			add_location(div13, file$1, 130, 4, 4193);
    			add_location(small, file$1, 134, 6, 4367);
    			attr_dev(div14, "class", "col-start-2 col-end-12 text-center");
    			add_location(div14, file$1, 133, 4, 4312);
    			attr_dev(div15, "class", "col-start-5 col-span-4 ");
    			add_location(div15, file$1, 136, 4, 4429);
    			attr_dev(div16, "class", "grid grid-cols-12 gap-y-2");
    			add_location(div16, file$1, 129, 2, 4149);
    			attr_dev(div17, "class", "mt-10 mb-20");
    			add_location(div17, file$1, 128, 0, 4121);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
