    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div1, "class", "grid grid-cols-12 gap-x-2 gap-y-16");
    			add_location(div1, file$1, 71, 2, 2311);
    			attr_dev(p1, "class", "text-2xl");
    			add_location(p1, file$1, 78, 6, 2624);
    			attr_dev(div2, "class", "col-start-2 col-end-12 text-center");
    			add_location(div2, file$1, 77, 4, 2569);
    			attr_dev(p2, "class", "text-blue-400 text-2xl");
    			add_location(p2, file$1, 81, 6, 2747);
    			attr_dev(div3, "class", "col-start-2 col-end-12 text-center");
    			add_location(div3, file$1, 80, 4, 2692);
    			attr_dev(div4, "class", "grid grid-cols-12 gap-x-2 gap-y-8");
    			add_location(div4, file$1, 76, 2, 2517);
    			attr_dev(div5, "class", "mt-20");
    			add_location(div5, file$1, 70, 0, 2289);
    			add_location(h60, file$1, 88, 6, 2964);
    			attr_dev(div6, "class", "col-start-2 col-end-12 text-center mb-2 ");
    			add_location(div6, file$1, 87, 4, 2903);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 95, 12, 3250);
    			add_location(h61, file$1, 101, 12, 3453);
    			add_location(label0, file$1, 94, 10, 3230);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 92, 8, 3127);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 106, 12, 3567);
    			add_location(h62, file$1, 112, 12, 3771);
    			add_location(label1, file$1, 105, 10, 3547);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 104, 8, 3511);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 117, 12, 3886);
    			add_location(h63, file$1, 123, 12, 4094);
    			add_location(label2, file$1, 116, 10, 3866);
    			attr_dev(div9, "class", "text-center");
    			add_location(div9, file$1, 115, 8, 3830);
    			attr_dev(div10, "class", "flex justify-center space-x-8");
    			add_location(div10, file$1, 91, 6, 3074);
    			attr_dev(div11, "class", "col-start-1 col-end-13 text-center mb-2 ");
    			add_location(div11, file$1, 90, 4, 3013);
    			attr_dev(div12, "class", "grid grid-cols-12 gap-y-2 gap-x-6");
    			add_location(div12, file$1, 86, 2, 2851);
    			attr_dev(div13, "class", "mt-10");
    			add_location(div13, file$1, 85, 0, 2829);
    			add_location(h64, file$1, 133, 6, 4316);
    			attr_dev(div14, "class", "col-start-2 col-end-12 text-center");
    			add_location(div14, file$1, 132, 4, 4261);
    			...
    			add_location(div18, file$1, 130, 0, 4189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
