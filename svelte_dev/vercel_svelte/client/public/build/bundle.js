    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$1, 73, 6, 2420);
    			attr_dev(div0, "class", "col-start-2 col-end-12 text-center ");
    			add_location(div0, file$1, 72, 4, 2364);
    			attr_dev(p1, "class", "text-2xl");
    			add_location(p1, file$1, 76, 6, 2565);
    			attr_dev(div1, "class", "col-start-2 col-end-12 text-center");
    			add_location(div1, file$1, 75, 4, 2510);
    			attr_dev(p2, "class", "text-blue-400 text-2xl");
    			add_location(p2, file$1, 79, 6, 2685);
    			attr_dev(div2, "class", "col-span-2 col-end-12 text-left");
    			add_location(div2, file$1, 78, 4, 2633);
    			attr_dev(div3, "class", "grid grid-cols-12 gap-x-2 gap-y-16");
    			add_location(div3, file$1, 71, 2, 2311);
    			attr_dev(div4, "class", "mt-20");
    			add_location(div4, file$1, 70, 0, 2289);
    			add_location(h60, file$1, 86, 6, 2892);
    			attr_dev(div5, "class", "col-start-2 col-end-12 text-center mb-2 ");
    			add_location(div5, file$1, 85, 4, 2831);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 91, 8, 3064);
    			add_location(h61, file$1, 97, 8, 3243);
    			add_location(label0, file$1, 90, 6, 3048);
    			attr_dev(div6, "class", "col-start-4 text-center");
    			add_location(div6, file$1, 88, 4, 2941);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 102, 8, 3337);
    			add_location(h62, file$1, 108, 8, 3517);
    			add_location(label1, file$1, 101, 6, 3321);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 100, 4, 3289);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 113, 8, 3612);
    			add_location(h63, file$1, 119, 8, 3796);
    			add_location(label2, file$1, 112, 6, 3596);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 111, 4, 3564);
    			attr_dev(div9, "class", "grid grid-cols-12 gap-1");
    			add_location(div9, file$1, 84, 2, 2789);
    			attr_dev(div10, "class", "mt-10");
    			add_location(div10, file$1, 83, 0, 2767);
    			add_location(h64, file$1, 127, 6, 3986);
    			attr_dev(div11, "class", "col-start-2 col-end-12 text-center");
    			add_location(div11, file$1, 126, 4, 3931);
    			add_location(small, file$1, 130, 6, 4105);
    			attr_dev(div12, "class", "col-start-2 col-end-12 text-center");
    			add_location(div12, file$1, 129, 4, 4050);
    			attr_dev(div13, "class", "col-start-4 col-span-6 ");
    			add_location(div13, file$1, 132, 4, 4167);
    			attr_dev(div14, "class", "grid grid-cols-12 gap-y-2");
    			add_location(div14, file$1, 125, 2, 3887);
    			attr_dev(div15, "class", "mt-10 mb-20");
    			add_location(div15, file$1, 124, 0, 3859);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(slider, div13, null);
    			current = true;
