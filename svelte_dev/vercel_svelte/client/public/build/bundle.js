    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h60, file$1, 86, 6, 2905);
    			attr_dev(div5, "class", "col-start-2 col-end-12 text-center mb-2 ");
    			add_location(div5, file$1, 85, 4, 2844);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 93, 12, 3189);
    			add_location(h61, file$1, 99, 12, 3392);
    			add_location(label0, file$1, 92, 10, 3169);
    			attr_dev(div6, "class", "text-center");
    			add_location(div6, file$1, 90, 8, 3066);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 104, 12, 3506);
    			add_location(h62, file$1, 110, 12, 3710);
    			add_location(label1, file$1, 103, 10, 3486);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 102, 8, 3450);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 115, 12, 3825);
    			add_location(h63, file$1, 121, 12, 4033);
    			add_location(label2, file$1, 114, 10, 3805);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 113, 8, 3769);
    			attr_dev(div9, "class", "flex justify-center gap-x-6");
