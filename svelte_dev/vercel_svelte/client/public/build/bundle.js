    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 91, 8, 3032);
    			add_location(h61, file$1, 97, 8, 3211);
    			add_location(label0, file$1, 90, 6, 3016);
    			add_location(div6, file$1, 88, 4, 2941);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 102, 8, 3285);
    			add_location(h62, file$1, 108, 8, 3465);
    			add_location(label1, file$1, 101, 6, 3269);
    			add_location(div7, file$1, 100, 4, 3257);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 113, 8, 3540);
    			add_location(h63, file$1, 119, 8, 3724);
    			add_location(label2, file$1, 112, 6, 3524);
    			add_location(div8, file$1, 111, 4, 3512);
    			...
    			add_location(h64, file$1, 127, 6, 3914);
    			attr_dev(div11, "class", "col-start-2 col-end-12 text-center");
    			add_location(div11, file$1, 126, 4, 3859);
    			add_location(small, file$1, 130, 6, 4033);
    			attr_dev(div12, "class", "col-start-2 col-end-12 text-center");
    			add_location(div12, file$1, 129, 4, 3978);
    			attr_dev(div13, "class", "col-start-4 col-span-7 ");
    			add_location(div13, file$1, 132, 4, 4095);
    			attr_dev(div14, "class", "grid grid-cols-12 gap-y-2");
    			add_location(div14, file$1, 125, 2, 3815);
    			attr_dev(div15, "class", "mt-10 mb-20");
    			add_location(div15, file$1, 124, 0, 3787);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
