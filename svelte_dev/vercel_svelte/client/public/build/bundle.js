    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div3, "class", "grid grid-cols-12 gap-y-20");
    			add_location(div3, file$1, 60, 2, 1979);
    			add_location(h60, file$1, 73, 6, 2478);
    			attr_dev(div4, "class", "col-start-4 col-end-10 ");
    			add_location(div4, file$1, 72, 4, 2434);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 78, 8, 2598);
    			add_location(h61, file$1, 84, 8, 2777);
    			add_location(label0, file$1, 77, 6, 2582);
    			attr_dev(div5, "class", "col-start-4 col-end-5 text-center");
    			add_location(div5, file$1, 76, 4, 2528);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 89, 8, 2894);
    			add_location(h62, file$1, 95, 8, 3074);
    			add_location(label1, file$1, 88, 6, 2878);
    			attr_dev(div6, "class", "col-start-5 col-end-6 text-center ");
    			add_location(div6, file$1, 87, 4, 2823);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 100, 8, 3191);
    			add_location(h63, file$1, 106, 8, 3375);
    			add_location(label2, file$1, 99, 6, 3175);
    			attr_dev(div7, "class", "col-start-6 col-end-7 text-center");
    			add_location(div7, file$1, 98, 4, 3121);
    			attr_dev(div8, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div8, file$1, 71, 2, 2390);
    			add_location(h64, file$1, 112, 6, 3522);
    			add_location(small, file$1, 114, 6, 3578);
    			attr_dev(div9, "class", "col-start-4 col-end-10 ");
    			add_location(div9, file$1, 111, 4, 3478);
    			attr_dev(div10, "class", "grid grid-cols-12 gap-y-20");
    			add_location(div10, file$1, 110, 2, 3433);
    			attr_dev(div11, "class", "mt-20");
    			add_location(div11, file$1, 59, 0, 1957);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div9, t21);
    			mount_component(slider, div9, null);
    			current = true;
