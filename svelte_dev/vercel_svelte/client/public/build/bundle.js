    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 95, 12, 3256);
    			add_location(h61, file$1, 101, 12, 3459);
    			add_location(label0, file$1, 94, 10, 3236);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 92, 8, 3133);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 106, 12, 3573);
    			add_location(h62, file$1, 112, 12, 3777);
    			add_location(label1, file$1, 105, 10, 3553);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 104, 8, 3517);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 117, 12, 3892);
    			add_location(h63, file$1, 123, 12, 4100);
    			add_location(label2, file$1, 116, 10, 3872);
    			attr_dev(div9, "class", "text-center");
    			add_location(div9, file$1, 115, 8, 3836);
