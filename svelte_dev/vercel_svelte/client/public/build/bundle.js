    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 81, 10, 2496);
    			add_location(h61, file$1, 88, 10, 2710);
    			add_location(label0, file$1, 80, 6, 2478);
    			...
    			add_location(input1, file$1, 93, 10, 2819);
    			add_location(h62, file$1, 99, 10, 3011);
    			add_location(label1, file$1, 92, 6, 2801);
    			attr_dev(div5, "class", "col-start-6 col-end-8 ");
    			add_location(div5, file$1, 91, 6, 2758);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 104, 6, 3116);
    			add_location(h63, file$1, 110, 6, 3288);
    			add_location(label2, file$1, 103, 6, 3102);
    			attr_dev(div6, "class", "col-start-8 col-end-10 ");
    			add_location(div6, file$1, 102, 4, 3058);
    			add_location(u, file$1, 116, 54, 3427);
    			add_location(h64, file$1, 116, 6, 3379);
    			add_location(small, file$1, 118, 6, 3470);
    			attr_dev(div7, "class", "col-start-4 col-end-10 ");
    			add_location(div7, file$1, 114, 4, 3334);
