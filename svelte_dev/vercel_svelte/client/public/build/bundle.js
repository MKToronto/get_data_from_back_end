    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			small = element("small");
    			t21 = text("Value: ");
    			t22 = text(/*slider_value_front_end*/ ctx[0]);
    			t23 = space();
    			...
    			add_location(input0, file$1, 81, 10, 2545);
    			add_location(h61, file$1, 88, 10, 2759);
    			add_location(label0, file$1, 80, 6, 2527);
    			attr_dev(div4, "class", "col-start-4 col-end-6 ");
    			add_location(div4, file$1, 79, 0, 2484);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 93, 10, 2868);
    			add_location(h62, file$1, 99, 10, 3060);
    			add_location(label1, file$1, 92, 6, 2850);
    			attr_dev(div5, "class", "col-start-6 col-end-8 ");
    			add_location(div5, file$1, 91, 6, 2807);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 104, 6, 3165);
    			add_location(h63, file$1, 110, 6, 3337);
    			add_location(label2, file$1, 103, 6, 3151);
    			attr_dev(div6, "class", "col-start-8 col-end-10 ");
    			add_location(div6, file$1, 102, 4, 3107);
    			add_location(u1, file$1, 116, 54, 3476);
    			add_location(h64, file$1, 116, 6, 3428);
    			add_location(small, file$1, 118, 6, 3519);
    			attr_dev(div7, "class", "col-start-4 col-end-10 ");
    			add_location(div7, file$1, 114, 4, 3383);
    			attr_dev(div8, "class", "grid grid-cols-12 gap-y-20");
    			add_location(div8, file$1, 63, 2, 1948);
    			attr_dev(div9, "class", "mt-20");
    			add_location(div9, file$1, 62, 0, 1926);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div7, t23);
    			mount_component(slider, div7, null);
    			current = true;
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*slider_value_front_end*/ 1) set_data_dev(t22, /*slider_value_front_end*/ ctx[0]);
