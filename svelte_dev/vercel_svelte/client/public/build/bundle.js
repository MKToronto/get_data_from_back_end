    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h60, file$1, 87, 6, 2954);
    			attr_dev(div4, "class", "col-start-2 col-span-7 text-center mb-2 ");
    			add_location(div4, file$1, 86, 4, 2893);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 92, 8, 3075);
    			add_location(h61, file$1, 98, 8, 3254);
    			add_location(label0, file$1, 91, 6, 3059);
    			attr_dev(div5, "class", "col-start-2 col-span-2 text-center");
    			add_location(div5, file$1, 90, 4, 3004);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 103, 8, 3360);
    			add_location(h62, file$1, 109, 8, 3540);
    			add_location(label1, file$1, 102, 6, 3344);
    			attr_dev(div6, "class", "col-span-2 text-center ");
    			add_location(div6, file$1, 101, 4, 3300);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 114, 8, 3648);
    			add_location(h63, file$1, 120, 8, 3832);
    			add_location(label2, file$1, 113, 6, 3632);
    			attr_dev(div7, "class", "col-span-2 text-center ");
    			add_location(div7, file$1, 112, 4, 3587);
    			...
    			add_location(h64, file$1, 128, 6, 4022);
    			attr_dev(div10, "class", "col-start-2 col-span-6 text-center");
    			add_location(div10, file$1, 127, 4, 3967);
    			add_location(small, file$1, 131, 6, 4141);
    			attr_dev(div11, "class", "col-start-2 col-span-2 text-center");
    			add_location(div11, file$1, 130, 4, 4086);
    			attr_dev(div12, "class", "col-start-4 col-span-9 ");
    			add_location(div12, file$1, 133, 6, 4205);
    			attr_dev(div13, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div13, file$1, 126, 2, 3923);
    			attr_dev(div14, "class", "mt-10 mb-20");
    			add_location(div14, file$1, 125, 0, 3895);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
