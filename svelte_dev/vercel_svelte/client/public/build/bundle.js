    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div5, file$1, 85, 4, 2833);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 93, 12, 3171);
    			add_location(h61, file$1, 99, 12, 3374);
    			add_location(label0, file$1, 92, 10, 3151);
    			attr_dev(div6, "class", "text-center");
    			add_location(div6, file$1, 90, 8, 3048);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 104, 12, 3488);
    			add_location(h62, file$1, 110, 12, 3692);
    			add_location(label1, file$1, 103, 10, 3468);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 102, 8, 3432);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 115, 12, 3807);
    			add_location(h63, file$1, 121, 12, 4015);
    			add_location(label2, file$1, 114, 10, 3787);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 113, 8, 3751);
    			attr_dev(div9, "class", "flex justify-center ");
    			add_location(div9, file$1, 89, 6, 3004);
    			attr_dev(div10, "class", "col-start-1 col-end-13 text-center mb-2 ");
    			add_location(div10, file$1, 88, 4, 2943);
    			attr_dev(div11, "class", "grid grid-cols-12 gap-1");
    			add_location(div11, file$1, 84, 2, 2791);
    			attr_dev(div12, "class", "mt-10");
    			add_location(div12, file$1, 83, 0, 2769);
    			add_location(h64, file$1, 131, 6, 4237);
    			attr_dev(div13, "class", "col-start-2 col-end-12 text-center");
    			add_location(div13, file$1, 130, 4, 4182);
    			add_location(small, file$1, 134, 6, 4356);
    			attr_dev(div14, "class", "col-start-2 col-end-12 text-center");
    			add_location(div14, file$1, 133, 4, 4301);
    			attr_dev(div15, "class", "col-start-5 col-span-4 ");
    			add_location(div15, file$1, 136, 4, 4418);
    			attr_dev(div16, "class", "grid grid-cols-12 gap-y-2");
    			add_location(div16, file$1, 129, 2, 4138);
    			attr_dev(div17, "class", "mt-10 mb-20");
    			add_location(div17, file$1, 128, 0, 4110);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
