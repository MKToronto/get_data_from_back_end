    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "col-start-1 col-end-13 text-center ");
    			add_location(div0, file$1, 73, 4, 2362);
    			attr_dev(p1, "class", "text-2xl");
    			add_location(p1, file$1, 77, 6, 2562);
    			attr_dev(div1, "class", "col-start-1 col-end-7 text-center");
    			add_location(div1, file$1, 76, 4, 2508);
    			attr_dev(p2, "class", "text-blue-400 text-2xl");
    			add_location(p2, file$1, 80, 6, 2685);
    			attr_dev(div2, "class", "col-start-7 col-end-13 text-center");
    			add_location(div2, file$1, 79, 4, 2630);
    			...
    			add_location(h60, file$1, 87, 6, 2891);
    			attr_dev(div5, "class", "col-start-1 col-end-13 mb-2 text-center");
    			add_location(div5, file$1, 86, 4, 2831);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 92, 8, 3011);
    			add_location(h61, file$1, 98, 8, 3190);
    			add_location(label0, file$1, 91, 6, 2995);
    			attr_dev(div6, "class", "col-start-1 col-end-5 text-center");
    			add_location(div6, file$1, 90, 4, 2941);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 103, 8, 3307);
    			add_location(h62, file$1, 109, 8, 3487);
    			add_location(label1, file$1, 102, 6, 3291);
    			attr_dev(div7, "class", "col-start-5 col-end-9 text-center ");
    			add_location(div7, file$1, 101, 4, 3236);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 114, 8, 3605);
    			add_location(h63, file$1, 120, 8, 3789);
    			add_location(label2, file$1, 113, 6, 3589);
    			attr_dev(div8, "class", "col-start-9 col-end-13 text-center");
    			add_location(div8, file$1, 112, 4, 3534);
    			attr_dev(div9, "class", "grid grid-cols-12 gap-1");
    			add_location(div9, file$1, 85, 2, 2789);
    			attr_dev(div10, "class", "mt-10");
    			add_location(div10, file$1, 84, 0, 2767);
    			add_location(h64, file$1, 128, 6, 3979);
    			attr_dev(div11, "class", "col-start-1 col-end-13 text-center");
    			add_location(div11, file$1, 127, 4, 3924);
    			add_location(small, file$1, 131, 6, 4098);
    			attr_dev(div12, "class", "col-start-1 col-end-13 text-center");
    			add_location(div12, file$1, 130, 4, 4043);
    			attr_dev(div13, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div13, file$1, 126, 2, 3880);
    			attr_dev(div14, "class", "mt-10 mb-20");
    			add_location(div14, file$1, 125, 0, 3852);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
