    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "col-start-2 col-end-12 ");
    			add_location(div0, file$1, 73, 4, 2362);
    			attr_dev(p1, "class", "text-2xl");
    			add_location(p1, file$1, 77, 6, 2542);
    			attr_dev(p2, "class", "text-blue-400 text-2xl");
    			add_location(p2, file$1, 77, 58, 2594);
    			attr_dev(div1, "class", "col-start-2 col-span-12 ");
    			...
    			attr_dev(div3, "class", "mt-20");
    			add_location(div3, file$1, 71, 0, 2287);
    			add_location(h60, file$1, 87, 6, 2921);
    			attr_dev(div4, "class", "col-start-2 col-span-7 mb-2 ");
    			add_location(div4, file$1, 86, 4, 2871);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 92, 8, 3031);
    			add_location(h61, file$1, 98, 8, 3210);
    			add_location(label0, file$1, 91, 6, 3015);
    			attr_dev(div5, "class", "col-start-2 col-span-2 ");
    			add_location(div5, file$1, 90, 4, 2971);
    			...
    			add_location(div6, file$1, 101, 4, 3256);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 114, 8, 3582);
    			add_location(h63, file$1, 120, 8, 3766);
    			add_location(label2, file$1, 113, 6, 3566);
    			attr_dev(div7, "class", "col-span-2 ");
    			add_location(div7, file$1, 112, 4, 3532);
    			attr_dev(div8, "class", "grid grid-cols-12 gap-1");
    			add_location(div8, file$1, 85, 2, 2829);
    			attr_dev(div9, "class", "mt-10");
    			add_location(div9, file$1, 84, 0, 2807);
    			add_location(h64, file$1, 128, 6, 3945);
    			attr_dev(div10, "class", "col-start-2 col-span-6 ");
    			add_location(div10, file$1, 127, 4, 3901);
    			add_location(small, file$1, 131, 6, 4053);
    			attr_dev(div11, "class", "col-start-2 col-span-2 ");
    			add_location(div11, file$1, 130, 4, 4009);
    			attr_dev(div12, "class", "col-start-2 col-span-8 ");
    			add_location(div12, file$1, 133, 6, 4117);
    			attr_dev(div13, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div13, file$1, 126, 2, 3857);
    			attr_dev(div14, "class", "mt-10 mb-20");
    			add_location(div14, file$1, 125, 0, 3829);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			if (!current || dirty & /*$value_to_send*/ 4) set_data_dev(t3, /*$value_to_send*/ ctx[2]);
