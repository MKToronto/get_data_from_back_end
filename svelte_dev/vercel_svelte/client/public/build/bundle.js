    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h60, file$1, 87, 6, 2837);
    			attr_dev(div5, "class", "col-start-4 col-end-10 mb-2");
    			add_location(div5, file$1, 86, 4, 2789);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 92, 8, 2957);
    			add_location(h61, file$1, 98, 8, 3136);
    			add_location(label0, file$1, 91, 6, 2941);
    			...
    			add_location(input1, file$1, 103, 8, 3253);
    			add_location(h62, file$1, 109, 8, 3433);
    			add_location(label1, file$1, 102, 6, 3237);
    			attr_dev(div7, "class", "col-start-5 col-end-6 text-center ");
    			add_location(div7, file$1, 101, 4, 3182);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 114, 8, 3550);
    			add_location(h63, file$1, 120, 8, 3734);
    			add_location(label2, file$1, 113, 6, 3534);
    			attr_dev(div8, "class", "col-start-6 col-end-7 text-center");
    			add_location(div8, file$1, 112, 4, 3480);
    			...
    			add_location(h64, file$1, 128, 6, 3913);
    			attr_dev(div11, "class", "col-start-4 col-end-10 ");
    			add_location(div11, file$1, 127, 4, 3869);
    			add_location(small, file$1, 131, 6, 4021);
    			attr_dev(div12, "class", "col-start-4 col-end-10 ");
    			add_location(div12, file$1, 130, 4, 3977);
    			attr_dev(div13, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div13, file$1, 126, 2, 3825);
    			attr_dev(div14, "class", "mt-10 mb-20");
    			add_location(div14, file$1, 125, 0, 3797);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
