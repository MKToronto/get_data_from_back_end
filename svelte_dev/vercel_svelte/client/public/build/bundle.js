    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 73, 4, 2373);
    			attr_dev(p1, "class", "text-2xl");
    			add_location(p1, file$1, 77, 6, 2551);
    			attr_dev(div1, "class", "col-start-5 col-end-8 ");
    			add_location(div1, file$1, 76, 4, 2508);
    			attr_dev(p2, "class", "text-blue-400 text-2xl");
    			add_location(p2, file$1, 80, 6, 2662);
    			attr_dev(div2, "class", "col-start-8 col-end-9 ");
    			add_location(div2, file$1, 79, 4, 2619);
    			attr_dev(div3, "class", "grid grid-cols-12 gap-y-16");
    			add_location(div3, file$1, 72, 2, 2328);
    			attr_dev(div4, "class", "mt-20");
    			add_location(div4, file$1, 71, 0, 2306);
    			add_location(h60, file$1, 87, 6, 2858);
    			attr_dev(div5, "class", "col-start-4 col-end-10 mb-2");
    			add_location(div5, file$1, 86, 4, 2810);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 92, 8, 2978);
    			add_location(h61, file$1, 98, 8, 3157);
    			add_location(label0, file$1, 91, 6, 2962);
    			attr_dev(div6, "class", "col-start-4 col-end-5 text-center");
    			add_location(div6, file$1, 90, 4, 2908);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 103, 8, 3274);
    			add_location(h62, file$1, 109, 8, 3454);
    			add_location(label1, file$1, 102, 6, 3258);
    			attr_dev(div7, "class", "col-start-5 col-end-6 text-center ");
    			add_location(div7, file$1, 101, 4, 3203);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 114, 8, 3571);
    			add_location(h63, file$1, 120, 8, 3755);
    			add_location(label2, file$1, 113, 6, 3555);
    			attr_dev(div8, "class", "col-start-6 col-end-7 text-center");
    			add_location(div8, file$1, 112, 4, 3501);
    			attr_dev(div9, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div9, file$1, 85, 2, 2766);
    			attr_dev(div10, "class", "mt-10");
    			add_location(div10, file$1, 84, 0, 2744);
    			add_location(h64, file$1, 128, 6, 3928);
    			attr_dev(div11, "class", "col-start-4 col-end-10 ");
    			add_location(div11, file$1, 127, 4, 3884);
    			add_location(small, file$1, 131, 6, 4036);
    			attr_dev(div12, "class", "col-start-4 col-end-10 ");
    			add_location(div12, file$1, 130, 4, 3992);
    			attr_dev(div13, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div13, file$1, 126, 2, 3840);
    			attr_dev(div14, "class", "mt-10");
    			add_location(div14, file$1, 125, 0, 3818);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
