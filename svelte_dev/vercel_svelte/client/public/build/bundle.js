    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$1, 76, 6, 2566);
    			...
    			add_location(p2, file$1, 79, 6, 2686);
    			attr_dev(div2, "class", "col-span-2 col-end-12 text-left");
    			add_location(div2, file$1, 78, 4, 2634);
    			...
    			add_location(h60, file$1, 86, 6, 2894);
    			attr_dev(div5, "class", "col-start-2 col-span-12 text-center mb-2 ");
    			add_location(div5, file$1, 85, 4, 2832);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 91, 8, 3034);
    			add_location(h61, file$1, 97, 8, 3213);
    			add_location(label0, file$1, 90, 6, 3018);
    			add_location(div6, file$1, 88, 4, 2943);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 102, 8, 3287);
    			add_location(h62, file$1, 108, 8, 3467);
    			add_location(label1, file$1, 101, 6, 3271);
    			add_location(div7, file$1, 100, 4, 3259);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 113, 8, 3542);
    			add_location(h63, file$1, 119, 8, 3726);
    			add_location(label2, file$1, 112, 6, 3526);
    			add_location(div8, file$1, 111, 4, 3514);
    			attr_dev(div9, "class", "grid grid-cols-12 gap-1");
    			add_location(div9, file$1, 84, 2, 2790);
    			attr_dev(div10, "class", "mt-10");
    			add_location(div10, file$1, 83, 0, 2768);
    			add_location(h64, file$1, 127, 6, 3917);
    			attr_dev(div11, "class", "col-start-2 col-span-12 text-center");
    			add_location(div11, file$1, 126, 4, 3861);
    			add_location(small, file$1, 130, 6, 4037);
    			attr_dev(div12, "class", "col-start-2 col-span-12 text-center");
    			add_location(div12, file$1, 129, 4, 3981);
    			attr_dev(div13, "class", "col-start-4 col-span-7 ");
    			add_location(div13, file$1, 132, 4, 4099);
    			attr_dev(div14, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div14, file$1, 125, 2, 3817);
    			attr_dev(div15, "class", "mt-10 mb-20");
    			add_location(div15, file$1, 124, 0, 3789);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
