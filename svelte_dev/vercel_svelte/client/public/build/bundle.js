    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h60, file$1, 77, 0, 2454);
    			attr_dev(div3, "class", "col-start-4 col-end-10 ");
    			add_location(div3, file$1, 76, 8, 2416);
    			attr_dev(input0, "type", "radio");
    			input0.__value = "Digits";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input0);
    			add_location(input0, file$1, 82, 10, 2568);
    			add_location(h61, file$1, 89, 10, 2782);
    			add_location(label0, file$1, 81, 6, 2550);
    			attr_dev(div4, "class", "col-start-4 col-end-5 text-center");
    			add_location(div4, file$1, 80, 0, 2496);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 94, 10, 2903);
    			add_location(h62, file$1, 100, 10, 3095);
    			add_location(label1, file$1, 93, 6, 2885);
    			attr_dev(div5, "class", "col-start-5 col-end-6 text-center ");
    			add_location(div5, file$1, 92, 6, 2830);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 105, 6, 3210);
    			add_location(h63, file$1, 111, 6, 3382);
    			add_location(label2, file$1, 104, 6, 3196);
    			attr_dev(div6, "class", "col-start-6 col-end-7 text-center");
    			add_location(div6, file$1, 103, 4, 3142);
    			attr_dev(div7, "class", "grid grid-cols-12 gap-y-4");
    			add_location(div7, file$1, 75, 6, 2368);
    			add_location(h64, file$1, 117, 6, 3479);
    			add_location(small, file$1, 119, 6, 3541);
    			attr_dev(div8, "class", "col-start-4 col-end-10 ");
    			add_location(div8, file$1, 115, 4, 3434);
    			attr_dev(div9, "class", "grid grid-cols-12 gap-y-20");
    			add_location(div9, file$1, 63, 2, 1948);
    			attr_dev(div10, "class", "mt-20");
    			add_location(div10, file$1, 62, 0, 1926);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
