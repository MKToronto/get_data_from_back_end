    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 93, 12, 3169);
    			add_location(h61, file$1, 99, 12, 3372);
    			add_location(label0, file$1, 92, 10, 3149);
    			attr_dev(div6, "class", "text-center");
    			add_location(div6, file$1, 90, 8, 3046);
    			attr_dev(input1, "type", "radio");
    			input1.__value = "Letters";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input1);
    			add_location(input1, file$1, 104, 12, 3486);
    			add_location(h62, file$1, 110, 12, 3690);
    			add_location(label1, file$1, 103, 10, 3466);
    			attr_dev(div7, "class", "text-center");
    			add_location(div7, file$1, 102, 8, 3430);
    			attr_dev(input2, "type", "radio");
    			input2.__value = "Punctuation";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[7][0].push(input2);
    			add_location(input2, file$1, 115, 12, 3805);
    			add_location(h63, file$1, 121, 12, 4013);
    			add_location(label2, file$1, 114, 10, 3785);
    			attr_dev(div8, "class", "text-center");
    			add_location(div8, file$1, 113, 8, 3749);
    			attr_dev(div9, "class", "flex justify-around ");
    			add_location(div9, file$1, 89, 6, 3002);
    			attr_dev(div10, "class", "col-start-2 col-end-12 text-center mb-2 ");
    			add_location(div10, file$1, 88, 4, 2941);
    			attr_dev(div11, "class", "grid grid-cols-12 gap-1");
    			add_location(div11, file$1, 84, 2, 2789);
    			attr_dev(div12, "class", "mt-10");
    			add_location(div12, file$1, 83, 0, 2767);
    			add_location(h64, file$1, 131, 6, 4235);
    			attr_dev(div13, "class", "col-start-2 col-end-12 text-center");
    			add_location(div13, file$1, 130, 4, 4180);
    			...
    			add_location(div17, file$1, 128, 0, 4108);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
